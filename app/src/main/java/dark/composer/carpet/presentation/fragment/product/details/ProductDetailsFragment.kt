...
import dark.composer.carpet.databinding.FragmentProductDetailsNewBinding
import dark.composer.carpet.presentation.fragment.BaseFragment
import dark.composer.carpet.presentation.fragment.adapters.ProductAdapter
import dark.composer.carpet.presentation.fragment.dialog.PopupMenu
import dark.composer.carpet.utils.BaseNetworkResult
import kotlinx.coroutines.launch
import javax.inject.Inject

class ProductDetailsFragment : BaseFragment<FragmentProductDetailsNewBinding>(FragmentProductDetailsNewBinding::inflate) {
    @Inject
    ...
    private val popUpMenu by lazy {
        PopupMenu(requireContext(),binding.more)
    }
    ...
    private fun action(){
        ...
        popUpMenu.setDeleteClickListener {
            Toast.makeText(requireContext(), "Delete", Toast.LENGTH_SHORT).show()
        }

        popUpMenu.setEditClickListener {
            Toast.makeText(requireContext(), "Edit", Toast.LENGTH_SHORT).show()
        }

        popUpMenu.setShareClickListener {
