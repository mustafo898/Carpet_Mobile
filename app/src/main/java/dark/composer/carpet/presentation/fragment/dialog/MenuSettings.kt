...
class MenuSettings(context: Context, imageView: ImageView) : PopupMenu(context, imageView) {
    ...
    init {
        menuInflater.inflate(R.menu.pop_up_menu_adm,menu)
        menu.findItem(R.id.edit).title = "Edit"
