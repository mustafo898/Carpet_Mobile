...
class ProductUncountableFragment : BaseFragment<FragmentUncountProductDetailsBinding>(FragmentUncountProductDetailsBinding::inflate){
    @Inject
    ...
    private fun action(){
        ...
        menuSettings.setEditClickListener {
            navController.navigate(R.id.action_productUncountableFragment_to_updateProductFragment, bundleOf("ID" to id, "TYPE" to type))
